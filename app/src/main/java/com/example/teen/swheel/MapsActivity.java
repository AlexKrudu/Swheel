...
public class MapsActivity extends AppCompatActivity  implements OnMarkerClickListener,
     ...
     */
        ...
        public void onMapReady(GoogleMap map) {
            ...
            mMap = map;
            for (int i = 0; i < 8; i++){
                mMap.addMarker(new MarkerOptions().position(new LatLng(lattitudes[i], longitudes[i]))
                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.user_1337))
                        .anchor(0.5f,  0.5f));
            }
    ...
    public boolean onMarkerClick(final Marker marker) {
        ...
        String bullshit = names[random.nextInt(6)];
